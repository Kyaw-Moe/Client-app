...
import com.testapp.clientappsub.Adapter.GenreAdapter;
...
import com.testapp.clientappsub.models.SlideModel;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        slideRef.addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                ...
                {
                    Toast.makeText(getContext(),"Save Error",Toast.LENGTH_LONG).show();
                }
            }
        });
