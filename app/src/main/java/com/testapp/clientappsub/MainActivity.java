...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvAppVersion.setText("Version " + com.testapp.clientappsub.BuildConfig.VERSION_NAME);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.share_menu:
                        ...
                        shareIntent.putExtra(Intent.EXTRA_TEXT, "https://play.google.com/store/apps/details?id=" + com.testapp.clientappsub.BuildConfig.APPLICATION_ID);
